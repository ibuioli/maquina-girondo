...
export class GeolocService {
  ...
  getLugPro(lat, lng){
    ...
    this.s.loadJSON("http://api.geonames.org/findNearbyJSON?lat="+lat+"&lng="+lng+"&lang=es&style=short&username=ibuioli", function(err, data){
    ...
    let proxyUrl = 'https://cors-anywhere.herokuapp.com/',
        targetUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat+","+lng+"&language=es&rankby=distance&types=establishment&key=AIzaSyCXodxfGv7qhVkx4-KJcAbFisjm020GvQI";
